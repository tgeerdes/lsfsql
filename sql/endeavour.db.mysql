...
--
-- Table structure for table `endeavour_jobFinishLog`
--
 
DROP TABLE IF EXISTS `endeavour_jobFinishLog`;
CREATE TABLE IF NOT EXISTS `endeavour_jobFinishLog` (
...
--
-- Table structure for table `endeavour_jobFinishLog_askedHosts`
--
 
DROP TABLE IF EXISTS `endeavour_jobFinishLog_askedHosts`;
CREATE TABLE IF NOT EXISTS `endeavour_jobFinishLog_askedHosts` (
  `jobId` int(32) unsigned NOT NULL COMMENT 'The unique ID for the job. ',
...
--
-- Table structure for table `endeavour_jobFinishLog_execHosts`
--
 
DROP TABLE IF EXISTS `endeavour_jobFinishLog_execHosts`;
CREATE TABLE IF NOT EXISTS `endeavour_jobFinishLog_execHosts` (
  `jobId` int(32) unsigned NOT NULL COMMENT 'The unique ID for the job. ',
  `submitTime` int(32) unsigned NOT NULL DEFAULT '0' COMMENT 'Job submission time.',
  `idx` int(32) NOT NULL COMMENT 'Job array index.',
  `name` text NOT NULL COMMENT 'The host name.',
...
--
-- Table structure for table `endeavour_jobFinishLog_hRusages`
--
 
DROP TABLE IF EXISTS `endeavour_jobFinishLog_hRusages`;
CREATE TABLE IF NOT EXISTS `endeavour_jobFinishLog_hRusages` (
  `jobId` int(32) unsigned NOT NULL COMMENT 'The unique ID for the job. ',
  `submitTime` int(32) unsigned NOT NULL DEFAULT '0' COMMENT 'Job submission time.',
  `idx` int(32) NOT NULL COMMENT 'Job array index.',
  `name` text NOT NULL COMMENT 'The host name.',
...
--
-- Table structure for table `endeavour_rsvFinishLog`
--
 
DROP TABLE IF EXISTS `endeavour_rsvFinishLog`;
CREATE TABLE IF NOT EXISTS `endeavour_rsvFinishLog` (
...
--
-- Table structure for table `endeavour_rsvFinishLog_alloc`
--
 
DROP TABLE IF EXISTS `endeavour_rsvFinishLog_alloc`;
CREATE TABLE IF NOT EXISTS `endeavour_rsvFinishLog_alloc` (
  `rsvId` text NOT NULL COMMENT 'Reservation ID.',
  `rsvReqTime` int(32) unsigned NOT NULL COMMENT 'Time when the reservation is required. ',
