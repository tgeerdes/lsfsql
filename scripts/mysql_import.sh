...
SQLquery=$(echo "
use LSF;
LOAD DATA LOCAL INFILE '$jobFinishLog' REPLACE
...
SHOW WARNINGS;
LOAD DATA LOCAL INFILE '$jobFinishLog_exec' REPLACE
    ...
    LINES TERMINATED BY '\\n';
SHOW WARNINGS;
LOAD DATA LOCAL INFILE '$jobFinishLog_asked' REPLACE
    ...
    LINES TERMINATED BY '\\n';
SHOW WARNINGS;
LOAD DATA LOCAL INFILE '$jobFinishLog_usage' REPLACE
    ...
    LINES TERMINATED BY '\\n';
SHOW WARNINGS; 
LOAD DATA LOCAL INFILE '$rsvFinishLog' REPLACE
    ...
    LINES TERMINATED BY '\\n';
SHOW WARNINGS;  
LOAD DATA LOCAL INFILE '${rsvFinishLog_alloc}' REPLACE
